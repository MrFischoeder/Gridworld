...
describe('loadChar', () => {
  it('loads a v3 save as is', () => {
    ...
    expect(loadChar(store({ [SAVE_KEY]: JSON.stringify(v3) }))).toEqual({ ...v3, time: 480, gunMods: [null, null, null], kcal: 2400, stomach: 0, water: 100, harvest: {}, benches: [], claims: [], hands: [{ k: 'blaster', n: 1 }], back: [{ k: 'blade', n: 1 }, null], wear: {}, pid: expect.any(String), towns: {}, market: {}, ledger: {}, caravans: {}, escort: null, contracts: [], taken: [], boards: {}, name: '', houses: [], shuttle: { given: {} } });
