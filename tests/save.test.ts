...
describe('loadChar', () => {
  it('loads a v3 save as is', () => {
    ...
    expect(loadChar(store({ [SAVE_KEY]: JSON.stringify(v3) }))).toEqual({ ...v3, time: 480, gunMods: [null, null, null], kcal: 2400, stomach: 0, water: 100, harvest: {}, benches: [], claims: [], hands: [{ k: 'blaster', n: 1 }], back: [{ k: 'blade', n: 1 }, null], wear: {}, pid: expect.any(String), towns: {}, market: {}, ledger: {}, caravans: {}, escort: null, contracts: [], taken: [], boards: {} });
    const timed = { ...v3, time: 5000, gunMods: ['scope', null, 'magX'], kcal: 1234, stomach: 0.6, water: 12, harvest: { 'pod:3:-2': 4000 }, benches: [], claims: [], hands: [null], back: [{ k: 'blaster', n: 1 }, { k: 'blade', n: 1 }], wear: { head: 'helmet' }, pid: 'abc123', towns: { '5': { wall: 1, fixed: 3000 } }, market: { '5:ore': { d: -3, t: 4000 } }, ledger: {}, caravans: { 'x:1': 2 }, escort: null, contracts: [], taken: [], boards: {} };
