...
import type { Robot } from './world/robots';
...
export const W = {
  ...
  drones: [] as Drone[], bosses: [] as Boss[], orbs: [] as Orb[], creatures: [] as Creature[], bandits: [] as Bandit[], robots: [] as Robot[], spawnCells: [] as [number, number, number][],
