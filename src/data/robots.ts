...
export interface RobotSpec {
  ...
  /** Overall height (m): indoors (crashed ships) a robot only goes where the ceiling clears it. */
  h: number;
...
export const ROBOTS: Record<RobotKind, RobotSpec> = {
  scout: { code: 'RD-03', name: 'Scout Automaton', role: 'Fast, blade-armed hunter; flanks in packs', r: 0.8, lift: 0.95, h: 1.8, hp: 3, speed: 8.5, armour: 1, sight: 38, min: 1, cost: 1, dmg: 8,
    loot: [['scrap', 0.8, 1, 2], ['circuit', 0.25, 1, 1]], crystals: 2 },
  guardian: { code: 'RD-01', name: 'Guardian Drone', role: 'Four-legged combat automaton with an energy cannon', r: 1.0, lift: 1.25, h: 2.2, hp: 6, speed: 3.4, armour: 0.85, sight: 34, min: 1.8, cost: 1.5, dmg: 6,
    loot: [['scrap', 1, 2, 3], ['circuit', 0.5, 1, 1]], crystals: 3 },
  repair: { code: 'RD-05', name: 'Repair Drone', role: 'Support: mends other machines, deploys defence drones', r: 0.95, lift: 1.7, h: 2.4, hp: 8, speed: 4, armour: 1, sight: 30, min: 3, cost: 1.5, dmg: 0,
    loot: [['circuit', 1, 1, 2], ['scrap', 0.7, 1, 1], ['pcore', 0.2, 1, 1]], crystals: 3 },
  sentinel: { code: 'RD-02', name: 'Sentinel', role: 'Heavy patrol unit: arm cannon and crushing blows', r: 1.5, lift: 2.0, h: 3.5, hp: 22, speed: 2.3, armour: 0.55, sight: 36, min: 4.5, cost: 4, dmg: 10,
    loot: [['scrap', 1, 4, 6], ['circuit', 0.8, 1, 2], ['pcore', 0.25, 1, 1]], crystals: 8 },
  artillery: { code: 'RD-04', name: 'Artillery Walker', role: 'Long-range shelling; slow and helpless up close', r: 1.7, lift: 2.3, h: 4, hp: 24, speed: 0.9, armour: 0.55, sight: 95, min: 5, cost: 4, dmg: 28,
    loot: [['scrap', 1, 5, 7], ['circuit', 1, 1, 2], ['pcore', 0.4, 1, 1]], crystals: 8 },
  assault: { code: 'RD-06', name: 'Assault Construct', role: 'Heavy melee: charges and smashes with its hammer', r: 1.6, lift: 2.1, h: 3.8, hp: 28, speed: 4.2, armour: 0.55, sight: 30, min: 6, cost: 4.5, dmg: 30,
