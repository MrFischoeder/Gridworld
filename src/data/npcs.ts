...
export type OptId = 'rest' | 'rumour' | 'work' | 'lore' | 'shop' | 'sell' | 'cook' | 'chat' | 'bye';
...
export const NPC_INFO: Record<NpcRole, NpcInfo> = {
  ...
  blacksmith: { name: 'Radek', title: 'Blacksmith', color: 0xff7a5c, hello: 'The forge is hot. Need something made? I also fit sights, barrels and magazines to blasters. Bring me hides, fangs and plates from the wilds and I will pay for them.', opts: ['shop', 'sell', 'work', 'bye'] },
...
export const OPT_TEXT: Record<OptId | 'back', string> = {
  ...
  shop: 'Show me your wares.', sell: 'I want to sell something.', cook: 'Roast my raw meat (2 gold a piece).', chat: 'How are things?', bye: 'Goodbye.', back: 'Back',
};
...
export const BUYS: Partial<Record<NpcRole, Partial<Record<ItemKey, number>>>> = {
  ...
  blacksmith: { hide: 14, fang: 9, plate: 22, membrane: 16, incisor: 5 },
};
