...
export type OptId = 'rest' | 'rumour' | 'work' | 'lore' | 'shop' | 'sell' | 'cook' | 'craft' | 'chat' | 'fortify' | 'trade' | 'bye';
...
export const NPC_INFO: Record<NpcRole, NpcInfo> = {
  ...
  elder: { name: 'Elder Bogdan', title: 'Village Elder', color: 0xe8fff0, hello: 'Ah, a new face. Welcome to Gridholm. Few travellers come this way since the machines woke up below us.', opts: ['lore', 'fortify', 'work', 'bye'] },
  ...
  merchant: { name: 'Zofia', title: 'General Store', color: 0xffd060, hello: 'Supplies for the brave and the foolish alike. Have a look. And if you deal in bulk, I buy and sell trade goods by the crate.', opts: ['shop', 'trade', 'work', 'bye'] },
...
export const OPT_TEXT: Record<OptId | 'back', string> = {
  ...
  shop: 'Show me your wares.', sell: 'I want to sell something.', cook: 'Roast my raw meat (2 gold a piece).', craft: 'Let me use your workbench (crafting).', chat: 'How are things?', fortify: 'How can I help the village? (walls and power)', trade: 'Trade goods by the crate (market).', bye: 'Goodbye.', back: 'Back',
};
