...
export type OptId = 'rest' | 'rumour' | 'work' | 'lore' | 'shop' | 'sell' | 'cook' | 'craft' | 'chat' | 'fortify' | 'trade' | 'contracts' | 'watch' | 'bye';
