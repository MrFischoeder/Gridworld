...
export const ITEMS = {
  ...
  boards: { name: 'Circuit Boards', ab: 'PCB', type: 'good', desc: 'processed good: etched boards from cable, resin and glass. The shuttle\'s avionics need them', stack: 5 },
  ...
  alloy: { name: 'Hull Alloy', ab: 'ALY', type: 'good', desc: 'processed good: heat-proof alloy plates cast from steel and copper. For the shuttle\'s hull', stack: 5 },
  propellant: { name: 'Rocket Propellant', ab: 'PRP', type: 'good', desc: 'processed good: fuel blended with salts at a chemical works. The shuttle burns it', stack: 5 },
