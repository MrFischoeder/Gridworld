...
export const ITEMS = {
  ...
  sand: { name: 'Sack of Quartz Sand', ab: 'SND', type: 'good', desc: 'trade good: clean quartz sand from a pit or a lake shore; a glassworks melts it into glass', stack: 5 },
  steel: { name: 'Steel Ingots', ab: 'STL', type: 'good', desc: 'processed good: iron ore smelted with coal. For machine parts and hull alloy', stack: 5 },
  copperbar: { name: 'Copper Ingots', ab: 'CUI', type: 'good', desc: 'processed good: copper ore smelted with coal. Drawn into cable, cast into alloy', stack: 5 },
  plastic: { name: 'Plastic Resin', ab: 'PLS', type: 'good', desc: 'processed good: resin cracked from crude oil at a refinery. For circuit boards', stack: 5 },
  glass: { name: 'Glass Panes', ab: 'GLS', type: 'good', desc: 'processed good: quartz sand melted with coal. Windows, lenses, heat tiles', stack: 5 },
  cable: { name: 'Copper Cable', ab: 'CBL', type: 'good', desc: 'processed good: copper ingots drawn into insulated cable', stack: 5 },
  boards: { name: 'Circuit Boards', ab: 'PCB', type: 'good', desc: 'processed good: etched boards from cable, resin and glass. The Chariot of the Ancients needs them for its avionics', stack: 5 },
  parts: { name: 'Machine Parts', ab: 'MPT', type: 'good', desc: 'processed good: gears, bearings and valves machined from steel. For engines', stack: 5 },
  alloy: { name: 'Hull Alloy', ab: 'ALY', type: 'good', desc: 'processed good: heat-proof alloy plates cast from steel and copper. For the hull of the Chariot of the Ancients', stack: 5 },
  propellant: { name: 'Rocket Propellant', ab: 'PRP', type: 'good', desc: 'processed good: fuel blended with salts at a chemical works. The Chariot of the Ancients burns it', stack: 5 },
  ...
  ironO: { name: 'Iron Ore', ab: 'FE', type: 'mat', desc: 'rust-red lumps broken out of a vein in the rock. Smelt it at a forge into metal and wire, or pack it into crates for the markets', stack: 10 },
  copperO: { name: 'Copper Ore', ab: 'CU', type: 'mat', desc: 'green-streaked lumps from a copper vein. A forge turns it into electronic components; crated, the markets buy it', stack: 10 },
