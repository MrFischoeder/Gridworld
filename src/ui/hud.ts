...
export const el = {
  ...
  sheet: $('sheet'), perf: $('perf'), veh: $('veh'), qtrack: $('qtrack'), clock: $('clock'), scope: $('scope'),
};
...
export function renderSheet() {
  ...
  el.sheet.innerHTML = (c.name ? '<b>' + c.name.replace(/[<>&]/g, '') + '</b> · ' : '') + where + 'Level ' + c.level + ', XP ' + c.xp + '/' + xpNeed(c.level) + ', gold ' + c.gold +
